...
int myFunction(int arrival_time[], int service_time[], int n,int job[])
{
    int completion[n], start[n], turnaround[n], waiting[n];
...
int main()
{
    ...
    int job[n], arrival_time[n], service_time[n];
    ...
    myFunction(arrival_time, service_time,n,job);
